...
public sealed class AddPaymentItemCommandHandler(
    IPaymentRepository paymentRepository,
    IUnitOfWork unitOfWork,
    ICurrentTenantService currentTenant)
    : IRequestHandler<AddPaymentItemCommand, Result<PaymentDto>>
{
    ...
    public async Task<Result<PaymentDto>> Handle(AddPaymentItemCommand request, CancellationToken ct)
    {
        ...
        var addResult = payment.AddItem(request.ProcedureId, request.Value);
